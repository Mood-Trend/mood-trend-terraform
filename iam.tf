...
resource "google_project_iam_member" "github_actions_functions_editor" {
  project = var.project_id
  role    = "roles/editor"
  member  = "serviceAccount:github-actions-functions@${var.project_id}.iam.gserviceaccount.com"
}

resource "google_project_iam_member" "github_actions_terraform_editor" {
  project = var.project_id
  role    = "roles/editor"
  member  = "serviceAccount:github-actions-terraform@${var.project_id}.iam.gserviceaccount.com"
}
...
resource "google_project_iam_member" "firebase_adminsdk_u21fw_firebase_sdkAdminServiceAgent" {
  ...
  member  = "serviceAccount:${var.firebase-adminsdk-service-account}@${var.project_id}.iam.gserviceaccount.com"
}
